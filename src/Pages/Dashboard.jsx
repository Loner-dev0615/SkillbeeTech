...
const Dashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white font-sans text-slate-900">
      ...
      <aside className="w-80 p-8 flex flex-col gap-8 border-l border-gray-50">
        <div>
          ...
          <div className="space-y-6">
            {recommendations.map((rec, i) => (
              <div key={i} className="flex items-center justify-between group cursor-pointer hover:bg-gray-50 p-2 -m-2 rounded-xl transition-colors">
        ...
        <div className="mt-auto bg-white border border-dashed border-gray-200 rounded-3xl p-8 text-center flex flex-col items-center">
          ...
          <button className="w-full bg-[#f35b23] text-white py-4 rounded-2xl font-bold shadow-lg shadow-orange-200 hover:bg-[#d84a1a] transition-colors active:scale-95">
            Upgrade to Premium
          </button>
        </div>
      </aside>
