...
import { Home, BarChart2, Bookmark, User, MessageSquare, Settings, LogOut, Search, Play, BookOpen, CheckCircle } from 'lucide-react';
...
const Dashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8F9FA] font-sans text-slate-900 rounded-2xl">
      ...
      <aside className="w-64 bg-white border-r border-gray-100 p-6 flex flex-col ">
        ...
        <button className="flex items-center gap-3 text-red-500 p-4 font-medium mt-auto">
          <LogOut size={20} />
          <a href="/landing">
            <span>Sign-out</span>
          </a>
